...
import { Search, User, Building, Calendar, FileText, Download, Eye, Loader2, AlertCircle } from 'lucide-react';
...
const AllApplications = () => {
  ...
  const exportToCSV = () => {
    const csvContent = [
      ['Candidate Name', 'Email', 'Phone', 'Job Title', 'Company', 'Status', 'Applied Date', 'Location'],
